...
public class GamePanel extends JPanel implements KeyListener, Runnable {
    ...
    public GamePanel() {
        ...
        // initialize image
        explode01 = Toolkit.getDefaultToolkit().getImage(GamePanel.class.getResource("/Image/explode01.png"));
        explode02 = Toolkit.getDefaultToolkit().getImage(GamePanel.class.getResource("/Image/explode02.png"));
        explode03 = Toolkit.getDefaultToolkit().getImage(GamePanel.class.getResource("/Image/explode03.png"));
        earth = Toolkit.getDefaultToolkit().getImage(GamePanel.class.getResource("/Image/Earth.png"));
    }
